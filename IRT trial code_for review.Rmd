...
data = fun_simulate_data(nitem, sample.size, "1PL", a_use, b,c_use, ability)
...
# Medium ability, 40 items, 1000 sample size, 50 iterations - flip the difficulty sign
results1 = fun_result_compile(iter, nitem, sample.size, a, b, c, med_ability)
...
# Create vectors to record final summary
	for (i in 1:iter){
dat_1PL = fun_simulate_data(nitem, sample.size, "1PL", a1, b,c1, med_ability)
...
dat_2PL = fun_simulate_data(nitem, sample.size, "2PL", a, b,c1, med_ability)
...
for (i in 1:iter){
dat_3PL = fun_simulate_data(nitem, sample.size, "3PL", a, b,c, med_ability)
model1PL <- mirt(data=dat_3PL, 1, itemtype='Rasch', SE=TRUE, verbose=FALSE)
model2PL <- mirt(data=dat_3PL, 1, itemtype='2PL', SE=TRUE, verbose=FALSE)
